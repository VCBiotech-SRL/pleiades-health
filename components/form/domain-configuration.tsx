...
export default function DomainConfiguration({ domain }: { domain: string }) {
  ...
  const txtVerification = (status === "Pending Verification" &&
          ...
          <>
            ...
            <div className="my-3 text-left">
              <p className="my-5 text-sm dark:text-white">
                ...
                ), set the following {recordType}{" "}
                record on your DNS provider to continue:
              </p>
              ...
              <p className="mt-5 text-sm dark:text-white">
                ...
                is not available, set the highest value possible. Also, domain
